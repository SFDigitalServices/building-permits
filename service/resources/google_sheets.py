...
ROW_JSON_MAP = {
    BUILDING_PERMIT_APPLICATION_WORKSHEET:[
        ...
        {'path':['data', 'constructionLenderAddressExisting', 'line1']},
        {'path':['data', 'constructionLenderAddressExisting', 'line2']},
        {'path':['data', 'constructionLenderAddressExisting', 'city']},
        {'path':['data', 'constructionLenderAddressExisting', 'state']},
        {'path':['data', 'constructionLenderAddressExisting', 'zip']},
        ...
        {'path':['data', 'constructionLenderAddressNew', 'line1']},
        {'path':['data', 'constructionLenderAddressNew', 'line2']},
        {'path':['data', 'constructionLenderAddressNew', 'city']},
        {'path':['data', 'constructionLenderAddressNew', 'state']},
        {'path':['data', 'constructionLenderAddressNew', 'zip']},
