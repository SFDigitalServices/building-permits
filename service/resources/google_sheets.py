...
ROW_JSON_MAP = {
    BUILDING_PERMIT_APPLICATION_WORKSHEET:[
        ...
        {'path':['data', 'agentAddress', 'line1']},
        {'path':['data', 'agentAddress', 'line2']},
        {'path':['data', 'agentAddress', 'city']},
        {'path':['data', 'agentAddress', 'state']},
        {'path':['data', 'agentAddress', 'zip']},
        {'path':['data', 'architectFirstName']},
        {'path':['data', 'architectLastName']},
        {'path':['data', 'architectPhoneNumber']},
        {'path':['data', 'architectAddress', 'line1']},
        {'path':['data', 'architectAddress', 'line2']},
        {'path':['data', 'architectAddress', 'city']},
        {'path':['data', 'architectAddress', 'state']},
        {'path':['data', 'architectAddress', 'zip']},
        {'path':['data', 'attorneyFirstName']},
        {'path':['data', 'attorneyLastName']},
        {'path':['data', 'attorneyPhoneNumber']},
        {'path':['data', 'attorneyAddress', 'line1']},
        {'path':['data', 'attorneyAddress', 'line2']},
        {'path':['data', 'attorneyAddress', 'city']},
        {'path':['data', 'attorneyAddress', 'state']},
        {'path':['data', 'attorneyAddress', 'zip']},
        {'path':['data', 'contractorFirstName']},
        {'path':['data', 'contractorLastName']},
        {'path':['data', 'contractorPhoneNumber']},
        {'path':['data', 'contractorAddress', 'line1']},
        {'path':['data', 'contractorAddress', 'line2']},
        {'path':['data', 'contractorAddress', 'city']},
        {'path':['data', 'contractorAddress', 'state']},
        {'path':['data', 'contractorAddress', 'zip']},
        {'path':['data', 'engineerFirstName']},
        {'path':['data', 'engineerLastName']},
        {'path':['data', 'engineerPhoneNumber']},
        {'path':['data', 'engineerAddress', 'line1']},
